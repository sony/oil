...
class DetailedEnsemblePpoBiddingStrategy(BaseBiddingStrategy):
    """
    ...
    },
    {
        ...
        "budget_range": 0,
        "cpa_range": 0,
        "path": "068_onbc_seed_42_new_data_realistic_60_obs_resume_053_with_period_27",
        "checkpoint": 16868520,
    },
    {
        "category": 2,
    ...
    def __init__(
        ...
        for path, checkpoint in zip(
            ...
            if path not in self.model_data_dict:
                self.model_data_dict[path] = {}
            self.model_data_dict[path][checkpoint] = {
                "model": model,
